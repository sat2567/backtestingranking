"""
Script to:
1. Merge LARGECAP_1.xlsx and LARGECAP_FUND_2.xlsx into one file
2. Download Nifty 100 data from Yahoo Finance starting Jan 1, 2006
3. Save the merged and downloaded data
"""
...
def merge_largecap_files():
    ...
    # Structure: Row 0 = blank, Row 1 = blank, Row 2 = fund names, Row 3 = headers, Row 4+ = data
...
def main():
    print("\n" + "=" * 60)
    print("LARGECAP MERGE & NIFTY 100 DOWNLOAD SCRIPT")
    print("=" * 60)
    print("\nPlease make sure all Excel files are closed before running this script!")
    ...
    try:
        ...
        print("\nNext steps:")
        print("1. The code has been updated to use these new files")
        print("2. Run the dashboard: streamlit run backtest_strategy.py")
